...
?>
	<?php if( $is_own_dashboard ) { ?>
	<h3 class="dashboard-none"><?php echo __( 'You have no listings at this time. ', APP_TD) . html_link( va_get_listing_create_url(), __( 'Click Here', APP_TD ) ) . __( ' to add a business listing now.', APP_TD ); // !TODO - Style this text ?></h3>
	<?php } else { ?>
