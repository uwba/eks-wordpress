    ...
    <div id="sidebar" class="threecol last">
        ...
        <aside class="widget">
            ...
            <ul>
                ...
                <li>W-2 forms for all jobs held in the tax year</li>
                <li>All 1099 or 1098 forms</li>
    ...
    if (is_user_logged_in()) {
        ...
        if ($is_own_dashboard) {
            ?>
                ...
                <?php } ?>
            </ul></div><?php } elseif (is_page_template('page-my-registration.php') || strpos('-' . $_SERVER["REQUEST_URI"], 'volunteer') || is_page_template('form-registration.php') || strpos('-' . $_SERVER["REQUEST_URI"], 'coordinator')) {
        ?>
        <div id="sidebar" class="threecol last">
            <h3>Login</h3>
        <?php if (is_page_template('page-my-registration.php') || strpos('-' . $_SERVER["REQUEST_URI"], 'volunteer')) { ?>
            ...
            <?php if (is_page_template('form-registration.php') || strpos('-' . $_SERVER["REQUEST_URI"], 'coordinator')) { ?>
                <p>Tax site coordinators, if you already have a tax site or sites, please login below to review or make changes.</p>
