        ...
        <div style="padding:10px">
          <div id="main-search" class="yui3-g">
            <div class="yui3-u-1-4">
              <label for="search-text"> <span class="search-title">
                <?php _e( 'Search For ', APP_TD ); ?>
                </span><br/>
                <span class="search-help">
                <?php _e( '(e.g., zip code, street name, site name)', APP_TD ); ?>
                </span> </label>
            ...
            <div class="yui3-u-1-4">
              <div class="search-location" style="padding-left:10px">
                <label> <span class="search-title">County</span> </label>
                <div class="input-cont h39">
            ...
            <div class="yui3-u-1-4">
              <div class="search-location">
                <label> <span class="search-title">City</span> </label>
                <div class="input-cont h39">
        ...
        jQuery(document).ready(function($) {
            ...
            <div class="yui3-u-1-4">
              <div class="search-button">
                ...
                <button type="submit" id="search-submit" class="rounded-small">
            ...
            <div class="yui3-u-1-4">
              <div class="search-location">
                <label> <span class="search-title">Language</span> </label>
                <div class="input-cont h39">
            ...
            <div class="yui3-u-1-4">
              <div class="search-location" style="padding-left:10px">
                <label> <span class="search-title">ADA Accessible?</span> </label>
                <div class="input-cont h39">
            ...
            <div class="yui3-u-1-4">
              <div class="search-location">
                <label> <span class="search-title">ITIN Applications Processed?</span> </label>
                <div class="input-cont h39">
