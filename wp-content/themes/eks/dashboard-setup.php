...
<div id="main">
	<div class="section-head">
        ...
        <div class="categories-list">
            ...
            <p>If you have any questions, you may contact your Site Coordinator or your <a href="/volunteer">County Volunteer Maestro</a>.</p>
            <p><a href="/volunteer">General volunteer information</a></p>
        </div>     
</div>
<?php } else {   
